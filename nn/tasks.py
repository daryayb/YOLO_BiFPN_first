...
from ultralytics.nn.modules import (AIFI, C1, C2, C3, C3TR, SPP, SPPF, Bottleneck, BottleneckCSP, C2f, RepViTBlock,
                                    C2f_Bottleneck_ATT, C3Ghost, C3x,
                                    Classify, Concat, Conv, Involution, CBAM, BoT3, GSConv, BiLevelRoutingAttention,
                                    CoordAtt, VoVGSCSP, Conv2, ConvTranspose, Detect, DWConv, DWConvTranspose2d,
...
class DetectionModel(BaseModel):
    ...
    def __init__(self, cfg='yolov8.yaml', ch=3, nc=None, verbose=True):  # model, input channels, number of classes
        super().__init__()
